...
<body bgcolor="#FFFFCC">
   <form name="updateReaderInfo_from" action="updateReaderInfoServlet?uname=${user.rName}" method="post" target="_self">
      <table align="center" width="400" cellspacing="5px">
			...
			<tr>
				...
				<td><c:out value="${user.rNo}"></c:out></td>
			</tr>
			<tr>
				<td  width="160px">类别：</td>
				<td><c:out value="${user.rSort}"></c:out></td>
			</tr>									
			<tr>
